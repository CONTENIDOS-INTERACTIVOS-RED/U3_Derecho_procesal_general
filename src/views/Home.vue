        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde el ejercicio profesional del Derecho, comprender las clases de procesos judiciales y su estructura dentro del Código General del Proceso, es fundamental para garantizar el respeto por el debido proceso y la materialización efectiva de los derechos sustanciales. En esta unidad, se abordarán los diferentes tipos de procesos civiles, declarativos, ejecutivos, liquidatorios y de jurisdicción voluntaria, así como sus etapas, las reglas probatorias y los principios que rigen la práctica y valoración de la prueba.
              
              p #[b ¡Prepárese para intervenir con rigor jurídico en cada etapa del proceso civil, con fundamento normativo y eficacia profesional!]
